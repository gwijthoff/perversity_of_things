...
[^agb]: More on Bell's father, Herman Melville Bell, and his alphabet of "visual speech" that inspired his son to work on the telephone.  Prosody collection on Zotero?  That tinkerer's thing where research into one problem (deafness) becomes the solution to another -- mass communication.  NYU prof disability studies stuff on this?

[^stm]: Gernsback's emphasis shifts in this editorial from verifiable probability (in "Fiction Versus Facts") to a spur, an inspiration to future invention.  Because given the wonders that we've seen in the past years, the prophecies fulfilled, one would be a fool to dismiss anything as impossible.  But the "truth" of "The Moon Hoax"?  Verifiably false yet counted as charming and imaginative.  Gernsback clarifies the difference in "Science Fiction Versus Science Faction."  An economy by which (prophetic) fiction is transformed into (scientific) fact.
